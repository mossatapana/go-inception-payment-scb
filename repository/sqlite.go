...
type PaymentRepository interface {
	Insert(data model.PaymentORM) error
...
func (pr PaymentRepo) Insert(data model.PaymentORM) error {
	...
	_, err = statement.Exec(data.Amount, data.Card, data.Currency, data.Status, data.Capture,
